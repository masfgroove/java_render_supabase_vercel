...
import br.com.api.produtos.servico.PedidoServico;
...
public class PedidoControle {
    ...
    public ResponseEntity<?> cadastrar(@RequestBody Pedido obj) {
        return servico.cadastrarAlterar(obj, "cadastrar");
    }

    @PutMapping("/alterar")
    public ResponseEntity<?> alterar(@RequestBody Pedido obj) {
